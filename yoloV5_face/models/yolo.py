...
class Detect(nn.Module):
    def __init__(self, nc=1, anchors=()):  # detection layer
...
class Model(nn.Module):
    def __init__(self, model_cfg='yolov5s.yaml', ch=3, nc=None):  # model, input channels, number of classes
        ...
        if type(model_cfg) is dict:
            ...
            with open(model_cfg,encoding="UTF-8", errors="ignore") as f:
                self.md = yaml.load(f, Loader=yaml.FullLoader)  # Model configuration information
