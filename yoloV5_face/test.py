...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', type=str, default='weights/yolo5_weights/yolov5s.pt', help='model.pt path')
    parser.add_argument('--data', type=str, default='yoloV5_face/data/coco.yaml', help='*.data path')
